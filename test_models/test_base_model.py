#!/usr/bin/python3
""" Unittest  BaseModelClass of codes"""
import unittest
import json
import pep8
import os
...
class TestBaseModel(unittest.TestCase):
    ...
    def test_docstring(self):
        """test docstring in the file used"""
    ...
    def test_is_instance(self):
        """Test that instantiation is correct in codes"""
    ...
    def test_attributes(self):
        """Test that instantiation is correct on codes"""
    ...
    def test_string(self):
        """check that displays correct string format output of codes"""
        bm_instance1_json = self.bm_instance1.to_dict()
    ...
    def test_save(self):
        """check on update changes of codes"""
        bm_instance1_json = self.bm_instance1.to_dict()
        bm_instance3 = BaseModel(**bm_instance1_json)
        self.bm_instance1.save()
    ...
    def test_dictionary(self):
        """check on to_dict module exists in  _ic of  class."""
